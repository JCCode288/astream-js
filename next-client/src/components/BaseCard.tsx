...
export default function BaseCard({ anime }: any) {
  return (
    <div className="card border-[3px] shadow-md shadow-primary rounded-sm border-primary items-stretch justify-center bg-base-200 align-middle text-base-content">
      <figure className="">
        <img
      ...
      <div className="card-body items-center text-center">
        ...
        <div className="card-actions">
          <Link href={`/details/${anime.episodeId}`}>
